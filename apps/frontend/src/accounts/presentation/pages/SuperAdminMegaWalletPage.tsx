            ...
            <ColumnLayout className={'PageContent PageContentDefaultPadding AppContent'} >
                ...
                <RowLayout className = { 'MainBoxContainer' } numColumns = { 2 } gap = { 16 } >
                    ...
                    <RowLayout className={'RoyaltyBoxesLayout'} numColumns = { 2 } gap = { 16 }>
                        ...
                        { renderBoxContainer(<TextWithTooltip text={'Pool Fee'} tooltipText={'The value here is used only in rewards calculator. The actual value that the platform depends on is set in CUDOS Markets PayService.'} />, settingsEntity.globalCudosFeesPercent, 'Change Pool Fee', onClickChangeGlobalFees) }
