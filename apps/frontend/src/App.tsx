...
const marketplacePageStore = new MarketplacePageStore(cudosStore, collectionRepo, nftRepo, miningFarmRepo);
...
const viewNftPageStore = new ViewNftPageStore(bitcoinStore, cudosStore, generalStore, accountSessionStore, nftRepo, collectionRepo, miningFarmRepo, statisticsRepo, accountRepo);
