...
const superAdminDashboardPageStore = new SuperAdminDashboardPageStore(statisticsRepo, miningFarmRepo, collectionRepo, walletStore, accountSessionStore, alertStore);
