...
import KycEntity, { KycStatus, KycStatusWithPartial } from '../../entities/KycEntity';
...
export default class KycStore {
    ...
    async createWorkflowRun(): Promise < void > {
        return this.kycRepo.createWorkflowRun(this.kycEntity);
    }
