...
@Module({
    imports: [SequelizeModule.forFeature([VisitorRepo, AccountRepo, UserRepo, AdminRepo, SuperAdminRepo, MiningFarmRepo, Collection, NFT, ManufacturerRepo, EnergySourceRepo, MinerRepo]), HttpModule],
