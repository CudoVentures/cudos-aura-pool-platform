...
ARG CUDOS_MARKETS_API_KEY

ENV WALLET_MNEMONIC=${MINTER_WALLET_MNEMONIC}
ENV CUDOS_MARKETS_BACKEND=${CUDOS_MARKETS_BACKEND}
...
ENV CUDOS_MARKETS_API_KEY=${CUDOS_MARKETS_API_KEY}
...
RUN echo "WALLET_MNEMONIC=\"${MINTER_WALLET_MNEMONIC}\"" > .env && \
    ...
    echo "CUDOS_MARKETS_BACKEND=${CUDOS_MARKETS_BACKEND}" >> .env && \
    ...
    echo "CUDOS_MARKETS_API_KEY=${CUDOS_MARKETS_API_KEY}" >> .env
